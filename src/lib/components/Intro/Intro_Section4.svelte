	...
	<defs>
		...
		<mask id="brush-mask" maskUnits="userSpaceOnUse" x="0" y="0" width="1512" height="870">
			...
			<g clip-path="url(#sfondo-clip)">
				<path id="mask-brush-path" d="M13.4746 291.27C13.4746 291.27 100.646 -18.6724 255.617 16.8418C410.588 52.356 61.0296 431.197 233.017 546.326C431.659 679.299 444.494 21.0125 652.73 100.784C860.967 180.556 468.663 430.709 617.216 546.326C765.769 661.944 819.097 48.2722 988.501 120.156C1174.21 198.957 809.424 543.841 988.501 636.726C1189.37 740.915 1301.67 149.213 1301.67 149.213" transform="translate(292.5, 879) rotate(-90) scale(1.0125, 2.25)" stroke="white" stroke-width="400" stroke-linecap="round" stroke-linejoin="round" fill="none" />
			</g>
		</mask>
	</defs>
</svg>

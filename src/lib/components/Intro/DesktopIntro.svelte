...
<div class="main-layout-container">
	...
	<div class="column-right">
		<p class="description-text" id="card-description">
			<span style="color: rgb(83, 62, 220)">Quasi tre volte l'intera popolazione mondiale.</span> Un flusso ininterrotto di sguardi incollati ai video di queste Olimpiadi Invernali.
		</p>
	</div>
</div>
